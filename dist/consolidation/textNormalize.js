...
const CONFUSABLE_MAP = Object.fromEntries(CONFUSABLE_PAIRS.map(([codePoint, latin]) => [String.fromCharCode(codePoint), latin]));
/**
...
const INVISIBLE_CHARS = new RegExp(`[${INVISIBLE_CODEPOINTS.map((codePoint) => String.fromCharCode(codePoint)).join("")}]`, "g");
/**
